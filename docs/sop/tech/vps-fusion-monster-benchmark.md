...
| WAWO 香港年付 39 1C0.5G | 香港低价小鸡基础测试 | 弱 | 中上偏弱 | 好 | 移动走 CMIN2 延迟低，电信联通绕远，IP 干净但性能弱 |
...
&emsp;&emsp;这台的关键矛盾在路由：标称香港，但电信和联通回国都绕远，只有移动走 CMIN2 延迟低。配合很弱的 CPU 和内存，它更适合对 IP 质量有要求、低负载、且主要走移动方向的轻量任务，不适合做电信联通主力或高负载服务。
